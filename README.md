...
My notes on the Circuit Theory relevant to this project can be found [here]()  

## 02-Circuit Design  
### 2.1-Deciding circuit topology  
[Notes on Deciding circuit topology]()  
  
### 2.2-Circuit Simulation (LTspice & MATLAB)  
[Ideal switch buck converter model]() 
[MATLAB_BUCK_CONVERTER_MODEL]()
